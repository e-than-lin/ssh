...
JSGantt.GanttChart =  function(pGanttVar, pDiv, pFormat)
{
      ...
      this.setCheckbox  = function(checkboxShow) { vCheckbox  = checkboxShow; };
      ...
      this.getCheckbox  = function(){ return vCheckbox };
   ...
   this.Draw = function()
   {
      ...
      if(vTaskList.length > 0)
      {
         ...
         vMainTable =
            ...
            '<TD vAlign=top id="rTD123"  bgColor=#ffffff> ';
         ...
         vLeftTable =
            '<DIV class=scroll id=leftside ><TABLE class="list_table" cellSpacing=0 cellPadding=0 border=0><TBODY>' +
            '<TR style="HEIGHT: 17px">' +
            '  <TD style="WIDTH: 15px; HEIGHT: 17px"></TD>' +
            '  <TD style="WIDTH: ' + vNameWidth + 'px; HEIGHT: 17px"><NOBR></NOBR></TD>'; 
         if(vCheckbox ==1) vLeftTable += '  <TD style="WIDTH: 30px; HEIGHT: 19px"></TD>' ;
         ...
         vLeftTable +=
            ...
            '  <TH style="BORDER-TOP: #efefef 1px solid; WIDTH: 15px; HEIGHT: 26px"></TH>' ;
         if(vCheckbox ==1) vLeftTable += '  <TH style="BORDER-TOP: #efefef 1px solid; FONT-SIZE: 12px; BORDER-LEFT: #efefef 1px solid;  HEIGHT: 26px" align=center nowrap><input type="checkbox" name="allNumber" id="allNumber" /></TH>' ;
         vLeftTable +='  <TH style="BORDER-TOP: #efefef 1px solid; WIDTH: ' + vNameWidth + 'px; HEIGHT: 26px"><NOBR>工作名称</NOBR></TH>' ;

         if(vShowRes ==1) vLeftTable += '  <TH style="BORDER-TOP: #efefef 1px solid; FONT-SIZE: 12px; BORDER-LEFT: #efefef 1px solid; WIDTH: 60px; HEIGHT: 26px" align=center nowrap>执行者</TH>' ;
         if(vShowDur ==1) vLeftTable += '  <TH style="BORDER-TOP: #efefef 1px solid; FONT-SIZE: 12px; BORDER-LEFT: #efefef 1px solid; WIDTH: 60px; HEIGHT: 26px" align=center nowrap>工期</TH>' ;
         if(vShowComp==1) vLeftTable += '  <TH style="BORDER-TOP: #efefef 1px solid; FONT-SIZE: 12px; BORDER-LEFT: #efefef 1px solid; WIDTH: 60px; HEIGHT: 26px" align=center nowrap>进度</TH>' ;
         if(vShowStartDate==1) vLeftTable += '  <TH style="BORDER-TOP: #efefef 1px solid; FONT-SIZE: 12px; BORDER-LEFT: #efefef 1px solid; WIDTH: 60px; HEIGHT: 26px" align=center nowrap>开始日期</TH>' ;
         if(vShowEndDate==1) vLeftTable += '  <TH style="BORDER-TOP: #efefef 1px solid; FONT-SIZE: 12px; BORDER-LEFT: #efefef 1px solid; WIDTH: 60px; HEIGHT: 26px" align=center nowrap>结束日期</TH>' ;
            ...
            for(i = 0; i < vTaskList.length; i++)
            {
               ...
               vID = vTaskList[i].getID();
                 ...
                 vLeftTable += '<TR id="child_' + vID + '" bgcolor=#' + vBGColor + ' onMouseover=g.mouseOver(this,"' + vID + '","left","' + vRowType + '") onMouseout=g.mouseOut(this,"' + vID + '","left","' + vRowType + '")>' ;
			      ...
			      if(vCheckbox ==1) vLeftTable += '  <TD class=gname style="WIDTH: 60px; HEIGHT: 20px; TEXT-ALIGN: center; BORDER-TOP: #efefef 1px solid; FONT-SIZE: 12px; BORDER-LEFT: #efefef 1px solid;" align=center><NOBR><input type="checkbox" name="ids" id="ids" value="'+vID+'"/></NOBR></TD>' ;
			     
			      
			      vLeftTable +=  '  <TD class=gname style="WIDTH: ' + vNameWidth + 'px; HEIGHT: 20px; BORDER-TOP: #efefef 1px solid; FONT-SIZE: 12px;" nowrap><NOBR><span style="color: #aaaaaa">';
               ...
               if(vTaskList[i].getLink()!=null && vTaskList[i].getLink()!="")
               {
            	   vLeftTable += 
                       '<span  style="cursor:pointer"><a  href="javascript:'+vTaskList[i].getLink()+'"> ' + vTaskList[i].getName() + '</a></span></NOBR></TD>' ;

               }
               else
               {
            	   vLeftTable += 
                       '<span  style="cursor:pointer"> ' + vTaskList[i].getName() + '</span></NOBR></TD>' ;
               ...
               if(vShowStartDate==1) vLeftTable += '  <TD class=gname style="WIDTH: 60px; HEIGHT: 20px; TEXT-ALIGN: center; BORDER-TOP: #efefef 1px solid; FONT-SIZE: 12px; BORDER-LEFT: #efefef 1px solid;" align=center><NOBR>' + JSGantt.formatDateStr( vTaskList[i].getStart(), "yyyy-mm-dd") + '</NOBR></TD>' ;
               if(vShowEndDate==1) vLeftTable += '  <TD class=gname style="WIDTH: 60px; HEIGHT: 20px; TEXT-ALIGN: center; BORDER-TOP: #efefef 1px solid; FONT-SIZE: 12px; BORDER-LEFT: #efefef 1px solid;" align=center><NOBR>' + JSGantt.formatDateStr( vTaskList[i].getEnd(), "yyyy-mm-dd") + '</NOBR></TD>' ;
...
//            vLeftTable += '<INPUT TYPE=RADIO NAME="other" VALUE="other" style="display:none"> .';
            ...
            vLeftTable += '</TD></TR>';//<TD><a onclick="gdisplay(\'gID123\');">dd</a></TD>
          //  if(vTaskList.length<10)
          //  {
            ///	 vLeftTable += '<tr><td style="HEIGHT: 150px;"></td></tr>';
           // }
           
            vLeftTable += '</TBODY></TABLE></DIV></TD>';
            ...
            // Draw the Chart Rows
            vRightTable = 
            '<TD  vAlign=top ID="gID123" bgColor=#ffffff>' +
         ...
         {	
            ...
            else if (vFormat == 'hour')
            {
	        ...
	        else if(vFormat == 'day' )
             {
               ...
               if(vTmpDate.getDay() % 6 == 0) {
                  vDateRowStr  += '<td class="gheadwkend" style="BORDER-TOP: #efefef 1px solid; FONT-SIZE: 12px; HEIGHT: 27px;  BORDER-LEFT: #efefef 1px solid;" bgcolor=#' + vWeekendColor + ' align=center><div style="width: '+vColWidth+'px">' + vTmpDate.getDate() + '</div></td>';
                  vItemRowStr  += '<td class="gheadwkend" style="BORDER-TOP: #efefef 1px solid; HEIGHT: 21px;FONT-SIZE: 12px; BORDER-LEFT: #efefef 1px solid; cursor: default;"  bgcolor=#' + vWeekendColor + ' align=center><div style="width: '+vColWidth+'px">&nbsp</div></td>';
               }
               else {
                  vDateRowStr += '<td class="ghead" style="BORDER-TOP: #efefef 1px solid; FONT-SIZE: 12px;  HEIGHT: 27px; BORDER-LEFT: #efefef 1px solid;"  bgcolor=#' + vWeekdayColor + ' align=center><div style="width: '+vColWidth+'px">' + vTmpDate.getDate() + '</div></td>';
                  if( JSGantt.formatDateStr(vCurrDate,'mm/dd/yyyy') == JSGantt.formatDateStr(vTmpDate,'mm/dd/yyyy')) 
                     vItemRowStr += '<td class="ghead" style="BORDER-TOP: #efefef 1px solid; FONT-SIZE: 12px; width: '+vColWidth+'px;HEIGHT: 21px;  BORDER-LEFT: #efefef 1px solid; cursor: default;"  bgcolor=#' + vWeekdayColor + ' align=center><div style="width: '+vColWidth+'px">&nbsp&nbsp</div></td>';
                  else
                     vItemRowStr += '<td class="ghead" style="BORDER-TOP: #efefef 1px solid;FONT-SIZE: 12px;HEIGHT: 21px; BORDER-LEFT: #efefef 1px solid; cursor: default;"  align=center><div style="width: '+vColWidth+'px">&nbsp&nbsp</div></td>';
               }
	         ...
	         else if(vFormat == 'week')
            {
               ...
               if(vNxtDate <= vMaxDate) {
                  vDateRowStr += '<td class="ghead" style="BORDER-TOP: #efefef 1px solid; FONT-SIZE: 12px; HEIGHT: 27px; BORDER-LEFT: #efefef 1px solid;" bgcolor=#' + vWeekdayColor + ' align=center width:'+vColWidth+'px><div style="width: '+vColWidth+'px">' + (vTmpDate.getMonth()+1) + '/' + vTmpDate.getDate() + '</div></td>';
                  if( vCurrDate >= vTmpDate && vCurrDate < vNxtDate ) 
                     vItemRowStr += '<td class="ghead" style="BORDER-TOP: #efefef 1px solid;HEIGHT: 21px; FONT-SIZE: 12px; BORDER-LEFT: #efefef 1px solid;" bgcolor=#' + vWeekdayColor + ' align=center><div style="width: '+vColWidth+'px">&nbsp&nbsp</div></td>';
                  else
                     vItemRowStr += '<td class="ghead" style="BORDER-TOP: #efefef 1px solid;HEIGHT: 21px; FONT-SIZE: 12px; BORDER-LEFT: #efefef 1px solid;" align=center><div style="width: '+vColWidth+'px">&nbsp&nbsp</div></td>';

               } else {
                  vDateRowStr += '<td class="ghead" style="BORDER-TOP: #efefef 1px solid; FONT-SIZE: 12px; HEIGHT: 27px; BORDER-LEFT: #efefef 1px solid; bgcolor=#' + vWeekdayColor + ' BORDER-RIGHT: #efefef 1px solid;" align=center width:'+vColWidth+'px><div style="width: '+vColWidth+'px">' + (vTmpDate.getMonth()+1) + '/' + vTmpDate.getDate() + '</div></td>';
                  if( vCurrDate >= vTmpDate && vCurrDate < vNxtDate ) 
                     vItemRowStr += '<td class="ghead" style="BORDER-TOP: #efefef 1px solid;HEIGHT: 21px; FONT-SIZE: 12px; BORDER-LEFT: #efefef 1px solid; BORDER-RIGHT: #efefef 1px solid;" bgcolor=#' + vWeekdayColor + ' align=center><div style="width: '+vColWidth+'px">&nbsp&nbsp</div></td>';
                  else
                     vItemRowStr += '<td class="ghead" style="BORDER-TOP: #efefef 1px solid;HEIGHT: 21px; FONT-SIZE: 12px; BORDER-LEFT: #efefef 1px solid; BORDER-RIGHT: #efefef 1px solid;" align=center><div style="width: '+vColWidth+'px">&nbsp&nbsp</div></td>';
	         ...
	         else if(vFormat == 'month')
            {
               ...
               if(vNxtDate <= vMaxDate) {
                  vDateRowStr += '<td class="ghead" style="BORDER-TOP: #efefef 1px solid; FONT-SIZE: 12px; HEIGHT: 27px; BORDER-LEFT: #efefef 1px solid;" bgcolor=#' + vWeekdayColor + ' align=center width:'+vColWidth+'px><div style="width: '+vColWidth+'px">' + vMonthArr[vTmpDate.getMonth()].substr(0,3) + '</div></td>';
                  if( vCurrDate >= vTmpDate && vCurrDate < vNxtDate ) 
                     vItemRowStr += '<td class="ghead" style="BORDER-TOP: #efefef 1px solid;HEIGHT: 21px; FONT-SIZE: 12px; BORDER-LEFT: #efefef 1px solid;" bgcolor=#' + vWeekdayColor + ' align=center><div style="width: '+vColWidth+'px">&nbsp&nbsp</div></td>';
                  else
                  ...
                  vDateRowStr += '<td class="ghead" style="BORDER-TOP: #efefef 1px solid;HEIGHT: 21px; FONT-SIZE: 12px; HEIGHT: 27px; BORDER-LEFT: #efefef 1px solid; BORDER-RIGHT: #efefef 1px solid;" bgcolor=#' + vWeekdayColor + ' align=center width:'+vColWidth+'px><div style="width: '+vColWidth+'px">' + vMonthArr[vTmpDate.getMonth()].substr(0,3) + '</div></td>';
                  if( vCurrDate >= vTmpDate && vCurrDate < vNxtDate ) 
                     vItemRowStr += '<td class="ghead" style="BORDER-TOP: #efefef 1px solid;HEIGHT: 21px; FONT-SIZE: 12px; BORDER-LEFT: #efefef 1px solid; BORDER-RIGHT: #efefef 1px solid;" bgcolor=#' + vWeekdayColor + ' align=center><div style="width: '+vColWidth+'px">&nbsp&nbsp</div></td>';
                  else
                     vItemRowStr += '<td class="ghead" style="BORDER-TOP: #efefef 1px solid;HEIGHT: 21px; FONT-SIZE: 12px; BORDER-LEFT: #efefef 1px solid; BORDER-RIGHT: #efefef 1px solid;" align=center><div style="width: '+vColWidth+'px">&nbsp&nbsp</div></td>';
	         ...
	         else if(vFormat == 'quarter')
            {
               ...
               if(vNxtDate <= vMaxDate) {
                  vDateRowStr += '<td class="ghead" style="BORDER-TOP: #efefef 1px solid; FONT-SIZE: 12px; HEIGHT: 27px; BORDER-LEFT: #efefef 1px solid;" bgcolor=#' + vWeekdayColor + ' align=center width:'+vColWidth+'px><div style="width: '+vColWidth+'px">Qtr. ' + vQuarterArr[vTmpDate.getMonth()] + '</div></td>';
                  if( vCurrDate >= vTmpDate && vCurrDate < vNxtDate ) 
                     vItemRowStr += '<td class="ghead" style="BORDER-TOP: #efefef 1px solid;HEIGHT: 21px; FONT-SIZE: 12px; BORDER-LEFT: #efefef 1px solid;" bgcolor=#' + vWeekdayColor + ' align=center><div style="width: '+vColWidth+'px">&nbsp&nbsp</div></td>';
                  else
                     vItemRowStr += '<td class="ghead" style="BORDER-TOP: #efefef 1px solid; HEIGHT: 21px;FONT-SIZE: 12px; BORDER-LEFT: #efefef 1px solid;" align=center><div style="width: '+vColWidth+'px">&nbsp&nbsp</div></td>';
               } else {
                  vDateRowStr += '<td class="ghead" style="BORDER-TOP: #efefef 1px solid; FONT-SIZE: 12px; HEIGHT: 27px; BORDER-LEFT: #efefef 1px solid; BORDER-RIGHT: #efefef 1px solid;" bgcolor=#' + vWeekdayColor + ' align=center width:'+vColWidth+'px><div style="width: '+vColWidth+'px">Qtr. ' + vQuarterArr[vTmpDate.getMonth()] + '</div></td>';
                  if( vCurrDate >= vTmpDate && vCurrDate < vNxtDate ) 
                     vItemRowStr += '<td class="ghead" style="BORDER-TOP: #efefef 1px solid;HEIGHT: 21px; FONT-SIZE: 12px; BORDER-LEFT: #efefef 1px solid; BORDER-RIGHT: #efefef 1px solid;" bgcolor=#' + vWeekdayColor + ' align=center><div style="width: '+vColWidth+'px">&nbsp&nbsp</div></td>';
                  else 
                     vItemRowStr += '<td class="ghead" style="BORDER-TOP: #efefef 1px solid; HEIGHT: 21px;FONT-SIZE: 12px; BORDER-LEFT: #efefef 1px solid; BORDER-RIGHT: #efefef 1px solid;" align=center><div style="width: '+vColWidth+'px">&nbsp&nbsp</div></td>';
	    ...
	    if(id=='1')
		 ...
		 else
		 {
		        document.getElementById("leftside").style.display = "";
				 ...
				 //  document.getElementById("rightside").style.width= document.getElementById("leftside").style.width;
   ...
   for(var i = 0; i < vList.length; i++)
   {
      if(vList[i].getParent() == pID) {
         ...
         if(vList[i].getGroup() == 1) 
        	...
        	{
        		vList[i].setOpen(0);
        		 JSGantt.findObj('group_'+vID).innerText = '+';
        	}
...
JSGantt.show =  function (pID, pTop, ganttObj) {
   ...
   for(var i = 0; i < vList.length; i++)
   {
      if(vList[i].getParent() == pID) {
         ...
         if(vList[i].getGroup() == 1) 
            JSGantt.show(vID,vList[i].getOpen(),ganttObj);
...
function gdisplay(id)
{
	
	if(JSGantt.findObj(id).style.display == "none")
	{
		JSGantt.findObj(id).style.display = "";
		//rTD123
	}
	else
	{
		JSGantt.findObj(id).style.display = "none";
	}
