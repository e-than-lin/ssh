    ...
    sorttable: function (setting) {
        ...
        function SetColumnOrder(headCell) {
            ...
            for(var i=0;i<rs.length;i++)
            {
            	if((i+1)%2==0)
            	{
            		 rs[i].className="td_even";
            		 rs[i].othClass="td_even";
            	}
            	else
            	{
            		 rs[i].className="td_odd";
            		 rs[i].othClass="td_odd";
            	}
            	if(configer.sqIndex!=-1)
            	{
            		 rs[i].children[configer.sqIndex-1].innerText=i+1;
            	}
