...
mvAry[mvAry.length] = ' <div name="calendarForm" style="margin: 0px;border-style:outset;border-width:2pt; border-color:#A3D1D1; background-color:#EFEFEF">';
mvAry[mvAry.length] = ' <table width="100%" border="0" cellpadding="0" cellspacing="1" style="font-size:12px;">';
mvAry[mvAry.length] = ' <tr>';
mvAry[mvAry.length] = ' <td height="15px" style="background-color:#9D9D9D" >日历控件' ;
...
if(document.all)
{
str += '<iframe id="ContainerPanel" style="z-index:12000;width:expression(this.previousSibling.offsetWidth);';
