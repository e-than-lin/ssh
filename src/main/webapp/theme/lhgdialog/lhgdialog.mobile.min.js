 (function($, window, undefined) {
    ...
    '<tbody >' + '<tr>' + '<td class="ui_lt"></td>' +
    '<td class="ui_t" ></td>' + 
    '<td class="ui_rt"></td>' + 
    '</tr>' + '<tr>' + '<td class="ui_l"></td>' + 
    '<td class="ui_c">' + '<div class="ui_inner">' + 
    '<table class="ui_dialog" style=" font-size:13px;color:#000;">' + '<tbody>' + '<tr>' + 
    '<td colspan="2">' + '<div class="ui_title_bar" >' + 
    '<div class="ui_title" unselectable="on" ></div>' + 
    '<div class="ui_title_buttons" >' + '<a class="ui_min" href="javascript:void(0);" title="\u6700\u5C0F\u5316"><b class="ui_min_b"></b></a>' + 
    ...
    '<a class="ui_close" href="javascript:void(0);" title="\u5173\u95ED(esc\u952E)"></a>' + '</div>' + '</div>' + '</td>' + '</tr>' + '<tr>' + '<td class="ui_icon" ></td>' + '<td class="ui_main">' + '<div class="ui_content"></div>' + '</td>' + '</tr>' + '<tr>' + '<td colspan="2">' + '<div class="ui_buttons"></div>' + '</td>' + '</tr>' + '</tbody>' + '</table>' + '</div>' + '</td>' + '<td class="ui_r" ></td>' + '</tr>' + '<tr>' + '<td class="ui_lb"></td>' + '<td class="ui_b"></td>' + '<td class="ui_rb"></td>' + '</tr>' + '</tbody>' + '</table>',
    _args,
    ...
    lhgdialog.fn = lhgdialog.prototype = {
        ...
        size: function(width, height) {
            ...
            style.width = width;
            style.height = height;
            if (width !== 'auto') wrap.style.width = wrap.offsetWidth + 'px';
            that._ie6SelectFix();
            return that;
        },
        ...
        lock: function() {
            ...
            if (!mask) {
                ...
                mask.style.cssText = 'position:' + positionType + ';left:0;top:0;width:100%;height:100%;overflow:hidden;overflow-y:hidden';
                style = mask.style;
        ...
        _iframe: function(url) {
            ...
            initCss = 'position:absolute;left:-9999em;border:none;background:transparent',
            loadCss = 'width:100%;height:100%;border:none;';
    ...
    lhgdialog.setting = {
        content: '<div class="ui_loading" ><span style="display:block;height:30px;width:30px;"></span></div>',
        title: '\u89C6\u7A97 ',
        button: null,
        ok: null,
        cancel: null,
    ...
    _use = function(event) {
        ...
        _dragEvent.onstart = function(x, y) {
            ...
            _$doc.bind('dblclick', _dragEvent.end); ! _ie6 && _isLosecapture ? title.bind('losecapture', _dragEvent.end) : _$top.bind('blur', _dragEvent.end);
        ...
        _dragEvent.onend = function(x, y) {
            _$doc.unbind('dblclick', _dragEvent.end); ! _ie6 && _isLosecapture ? title.unbind('losecapture', _dragEvent.end) : _$top.unbind('blur', _dragEvent.end);
...
})(this.jQuery || this.lhgcore, this);; (function($, lhgdialog, undefined) {
